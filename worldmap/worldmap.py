...
def _to_svg(df, attributesOUT, Param):
    ...
    f.write('<svg viewBox="0 0 1009 665" width="750px" xmlns="http://www.w3.org/2000/svg" xmlns:amcharts="http://amcharts.com/ammap" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1">\n\n\n')
    f.write('<defs>\n')
